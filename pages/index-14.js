    ...
    <>
      ...
      {screen === 'lot' && lot && (
        <div style={{background:'#080a0c',minHeight:'100vh'}}>
          {lot.demoExpired && (
            <div style={{position:'sticky',top:0,zIndex:50,background:'#C9302C',color:'white',textAlign:'center',padding:'10px 14px',fontSize:13,fontWeight:700,letterSpacing:'.02em'}}>
